...
def training(VDSR, config):
    ...
    test_labels_path = '{}/data/customSet5/ground_truth/*.npy'.format(main_data_path)
    test_inputs_path = '{}/data/customSet5/blur_{}x/*.npy'.format(main_data_path, default_test_scale)
    '''

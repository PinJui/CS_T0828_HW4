...
pkg load image
target = 'HR';
dataDir = fullfile('customSet5', target);
count = 0;
f_lst = dir(fullfile(dataDir, '*.png'));
folder_label = fullfile('customSet5', 'ground_truth');
folder_input_2x = fullfile('customSet5', 'blur_2x');
folder_input_3x = fullfile('customSet5', 'blur_3x');
folder_input_4x = fullfile('customSet5', 'blur_4x');
mkdir(folder_label);
